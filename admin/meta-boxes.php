...
function eaa_add_meta_boxes( $post ) {
	add_meta_box( 'food_meta_box', __( 'EAA Options', 'eaa' ), 'eaa_build_meta_box', 'post', 'side', 'high' );
	add_meta_box( 'food_meta_box', __( 'EAA Options', 'eaa' ), 'eaa_build_meta_box', 'page', 'side', 'high' );
}
